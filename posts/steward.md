...
held_by: the agent of a copy, by default, from the moment it is created — the same session held `founder` until then, and the post changed when `agent:` was filled
