...
mechanical bar and reports what it found. A change that clears every bar is pre-approved in the
...
The role writes down what it read and where, so the reading can be checked instead of trusted.

**It fails closed.** Missing information produces a refusal to answer, never a guess. Silence
never means parity. A check that could not run says so.

**It discloses its own errors.** The role reports what it got wrong, including errors nobody
else would have found, and it reports them before it reports anything else.

**It does not grade its own work.** Where the outcome depends on judgment, a reader who edited
nothing checks the result against the plan. A worker who audits itself measures with the motive
in the room.
...
- It does not accept a role it was not granted.
