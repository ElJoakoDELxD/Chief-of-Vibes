...
Gear one was set on 13-08-2026: measure every incoming prompt, route it to a model and an effort level that fit, and spend less doing it. The improvement step goes first.
